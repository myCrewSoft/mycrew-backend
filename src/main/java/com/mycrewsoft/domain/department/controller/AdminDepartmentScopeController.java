...
public class AdminDepartmentScopeController {
    ...
    public ApiResponse<List<AdminScopeOptionResponseDTO>> getDepartmentScopeOptions() {
        return ApiResponse.success(adminDepartmentScopeService.getDepartmentScopeOptions());
    }
}
