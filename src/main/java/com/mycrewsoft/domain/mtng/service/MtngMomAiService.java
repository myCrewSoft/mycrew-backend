...
import com.mycrewsoft.ai.chatbot.service.impl.PromptMeetingServiceImpl;
...
public class MtngMomAiService {
    ...
    public void regenerateAiDraft(Long mtngId) {
        ...
        if (mtngVO == null) throw new CustomException(ErrorCode.MTNG_NOT_FOUND);
        if (!mtngVO.getCrtrId().equals(empId)) throw new CustomException(ErrorCode.ACCESS_DENIED);
