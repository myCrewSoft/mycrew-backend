...
public interface ScheduleDtoMapper {
	...
	@Mapping(target = "writerId", source = "schdWrtrId")
	@Mapping(target = "writerName", source = "schdWrtrNm")
	@Mapping(target = "writerDeptNm", source = "schdWrtrDeptNm")
	@Mapping(target = "writerJobGrdNm", source = "schdWrtrJobGrdNm")
	@Mapping(target = "writerPrflImgFileId", source = "schdWrtrPrflImgFileId")
	@Mapping(target = "mtngId", source = "mtngId")
	@Mapping(target = "rsrvId", source = "rsrvId")
	@Mapping(target = "deptNm", source = "schdDeptNm")
	...
	@Mapping(target = "writerId",              source = "vo.schdWrtrId")
	@Mapping(target = "writerName",            source = "vo.schdWrtrNm")
	@Mapping(target = "writerDeptNm",          source = "vo.schdWrtrDeptNm")
	@Mapping(target = "writerJobGrdNm",        source = "vo.schdWrtrJobGrdNm")
	@Mapping(target = "writerPrflImgFileId",   source = "vo.schdWrtrPrflImgFileId")
	@Mapping(target = "mtngId",                source = "vo.mtngId")
	@Mapping(target = "rsrvId",                source = "vo.rsrvId")
	@Mapping(target = "deptNm", 			   source = "vo.schdDeptNm")
